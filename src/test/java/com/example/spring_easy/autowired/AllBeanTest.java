...
import com.example.spring_easy.AutoAppConfig;
...
public class AllBeanTest {
    ...
    void findAllBean(){
        ...
        int rateDiscoundPolicy = discountService.discount(member,20000,"rateDiscountPolicy");
        assertThat(rateDiscoundPolicy).isEqualTo(2000);
